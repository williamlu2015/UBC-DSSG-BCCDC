SELECT lab_table.test_key, lab_table.result_key,
    lab_table.result_full_description, dbo_table.tags, dbo_table.candidates,
    lab_table.level_1, lab_table.level_2
FROM (
...
) AS lab_table, dbo.level1_notnull_2 AS dbo_table
