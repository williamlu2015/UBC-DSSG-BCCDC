SELECT test_key, result_key, result_full_description,
    LOWER(test_outcome) AS test_outcome, result_date_key
FROM lab.dim_test_result_output AS table_0
WHERE (test_outcome = 'Positive'
        OR test_outcome = 'Negative'
        OR test_outcome = 'Indeterminate')
